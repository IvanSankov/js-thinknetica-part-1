...
* 7. Как мне в функции у Shipyard._validate понять какой тип корабля передан? Часть тестов не проходит из-за этого,
* потому что для верфей, где производят например, моторные лодки, парусный корабль тоже пройдет проверку.
* */